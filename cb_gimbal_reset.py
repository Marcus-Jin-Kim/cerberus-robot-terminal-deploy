...
## REMINDER: gimbal feedback is possible but very slow (chasis feedback is ok)

base.send_command({"T": 900, "main": 3, "module": 2})

import time
base.gimbal_ctrl(0, 0, 0, 0)
base.lights_ctrl(1, 1)
print("gimbal to 0,0,0,0 and lights to 100,100")
# print_feedback(t=10)

time.sleep(2)

base.gimbal_ctrl(60, 0, 0, 0)
base.lights_ctrl(0, 0)
print("gimbal to 60,0,0,0 and lights to 0,0")
time.sleep(2)
