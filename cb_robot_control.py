...
class CBRobotControl: # this should be top level robot controller later
    ...
    def __init__(self, cb_low_level_control:CBLowLevelControl, turret_cam_device_index=0, 
        ...
        self.turret_base_control = cb_low_level_control # body and turret can be the different controller later

        self.turret_cam_device_index = turret_cam_device_index
        self.turret_cam_width = turret_cam_width
        self.turret_cam_height = turret_cam_height
        self.turret_cam_fov = turret_cam_fov
        self.turret_cam_fps_cap = turret_cam_fps_cap
        self.turret_cam_jpeg_quality = turret_cam_jpeg_quality
        self.return_image = return_image        
        self.control_turret = control_turret
        self.auto_aim = auto_aim

        print(f"[CB]AITurretBackend init: control_turret={self.control_turret}, auto_aim={self.auto_aim}, return_image={self.return_image}")
        ...
        self.turret_hor_min = TURRET_HOR_MIN
        self.turret_hor_max = TURRET_HOR_MAX
        self.turret_ver_min = TURRET_VER_MIN
        self.turret_ver_max = TURRET_VER_MAX
        self.turret_step_hor_max = TURRET_HOR_STEP_MAX
        self.turret_step_ver_max = TURRET_VER_STEP_MAX
        self.turret_speed = TURRET_SPEED
        self.turret_acc = TURRET_ACC
        self.turret_aim_tolerance_px = TURRET_AIM_TOLERANCE_PX
        self.turret_aim_smoothing = TURRET_AIM_SMOOTHING
        self.turret_aim_cmd_delay = TURRET_AIM_CMD_DELAY
