...
public:
        ...
        : Node("base_node")
    {
        ...
        // CERBERUS added
        this->declare_parameter<int>("odom_publish_period_ms", 16);        
        ...
        if (period_ms < 1) period_ms = 10; // minimum 10ms
        ...
        // OLD timer_ = this->create_wall_timer(100ms, std::bind(&OdomPublisher::publish_odom, this));
        // timer_ = this->create_wall_timer(10ms, std::bind(&OdomPublisher::publish_odom, this));
        timer_ = this->create_wall_timer(
            std::chrono::milliseconds(period_ms),
            std::bind(&OdomPublisher::publish_odom, this));
        RCLCPP_INFO(this->get_logger(), "odom_publish_period_ms=%d", period_ms);
    }
